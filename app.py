...
one1 = pickle.load(open(r'D:\final_projects\Ride Price Prediction\pkl\encoder.pkl', "rb"))    
    
with open(r'D:\final_projects\Ride Price Prediction\pkl\le1.pkl', 'rb') as f:
    le = pickle.load(f) 
    
with open(r'D:\final_projects\Ride Price Prediction\pkl\linear_model1.pkl', 'rb') as f:
    linear=pickle.load(f)  
    
with open(r'D:\final_projects\Ride Price Prediction\pkl\feature_order.pkl', 'rb') as f:
    feature_order=pickle.load(f)  
    
with open(r'D:\final_projects\Ride Price Prediction\pkl\ride_catboost.pkl','rb') as f:
    catboost=pickle.load(f) 
    
with open(r'D:\final_projects\Ride Price Prediction\pkl\stacked_model_ride.pkl','rb') as f:

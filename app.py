...
one1 = pickle.load(open("/pkl/encoder.pkl", "rb"))    
    
with open("/pkl/le1.pkl", 'rb') as f:
    le = pickle.load(f) 
    
with open("/pkl/linear_model1.pkl", 'rb') as f:
    linear=pickle.load(f)  
    
with open("/pkl/feature_order.pkl", 'rb') as f:
    feature_order=pickle.load(f)  
    
with open("/pkl/ride_catboost.pkl",'rb') as f:
    catboost=pickle.load(f) 
    
with open("/pkl/stacked_model_ride.pkl",'rb') as f:
